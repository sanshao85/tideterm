...
- See the new [AI Modes documentation](https://sanshao85.github.io/tideterm/waveai-modes) for configuration examples and setup guides
...
**Other Changes:**
- Mobile user agent emulation support for web widgets [#2442](https://github.com/sanshao85/tideterm/issues/2442)
- [bugfix] Fixed padding for header buttons in code editor (Tailwind regression)
- [bugfix] Restored syntax highlighting in code editor preview blocks [#2427](https://github.com/sanshao85/tideterm/issues/2427)
- Package updates and dependency bumps
...
For more information and upcoming features, visit our [AI documentation](https://sanshao85.github.io/tideterm/waveai).
...
- Global hotkey support [docs](https://sanshao85.github.io/tideterm/config#customizable-systemwide-global-hotkey)
- Added configuration to override the font size for markdown, AI-chat, and preview editor [docs](https://sanshao85.github.io/tideterm/config)
...
- **Command Blocks**: New `wsh run` command for launching terminal commands in dedicated blocks, with support for magnification, auto-closing, and execution control ([docs](https://sanshao85.github.io/tideterm/wsh-reference#run))
- **Connections**: New configuration system for managing SSH connections, with support for wsh-free operation, per-connection themes, and more ([docs](https://sanshao85.github.io/tideterm/connections))
...
- Added Perplexity API integration ([docs](https://sanshao85.github.io/tideterm/faq#perplexity))
- `wsh setbg` command for background handling ([docs](https://sanshao85.github.io/tideterm/wsh-reference#setbg))
...
- Lots of new documentation, including new pages for [Getting Started](https://sanshao85.github.io/tideterm/gettingstarted), [AI Presets](https://sanshao85.github.io/tideterm/ai-presets), and [wsh overview](https://sanshao85.github.io/tideterm/wsh).
- Other bug fixes, performance improvements, and dependency updates
...
- `wsh setvar/getvar` to get and set variables -- [Docs](https://sanshao85.github.io/tideterm/wsh-reference#getvarsetvar)
- `wsh file` operations (cat, write, append, rm, info, cp, and ls) -- [Docs](https://sanshao85.github.io/tideterm/wsh-reference#file)
...
- [bugfix] Fix terminal theming when applying global defaults [#1287](https://github.com/sanshao85/tideterm/issues/1287)
...
New minor release with bug fixes and new features! Fixed the bug around making Wave fullscreen (also affecting certain window managers like Hyprland). We've also put a lot of work into the doc site (https://sanshao85.github.io/tideterm/), including documenting how [Widgets](./widgets) and [Presets](./presets) work!
...
- CLI applications that need microphone, camera, or location access will now work on MacOS. You'll see a security popup in Wave to allow/deny [#1086](https://github.com/sanshao85/tideterm/issues/1086)
...
- There is a new setting in the editor to enable/disable word wrapping [#1038](https://github.com/sanshao85/tideterm/issues/1038)
- Ctrl-S will now save files in codeedit [#1081](https://github.com/sanshao85/tideterm/issues/1081)
- [#1020](https://github.com/sanshao85/tideterm/issues/1020) there is now a preset config option to change the active border color in tab themes
- [bugfix] Multiple fixes for [#1167](https://github.com/sanshao85/tideterm/issues/1167) to try to address tab loss while updating
...
- [bugfix] [#1175](https://github.com/sanshao85/tideterm/issues/1175) can now edit .awk files
- [bugfix] [#1066](https://github.com/sanshao85/tideterm/issues/1066) applying a default theme now updates the background appropriately without a refresh
...
Lots of other smaller changes and bug fixes. See full list of PRs at https://github.com/sanshao85/tideterm/releases/tag/v0.9.0
...
- added support for Azure AI [See FAQ](https://sanshao85.github.io/tideterm/faq#how-can-i-connect-to-azure-ai)
...
- New "help" view -- uses an embedded version of our doc site -- https://sanshao85.github.io/tideterm/
...
- Use TideTerm's config/data directories consistently
...
Release Artificats and source code diffs can be found on (Github)[https://github.com/sanshao85/tideterm].
