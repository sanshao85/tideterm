...
Wave is an [open-source](https://github.com/sanshao85/tideterm) terminal that combines traditional terminal features with graphical capabilities like file previews, web browsing, and AI assistance. It runs on MacOS, Linux, and Windows.
...
If you have a question, please feel free to ask us in [Discord](https://discord.gg/XfvZ334gwU). If you'd like to file a bug/enchancement, please use [Github Issues](https://github.com/sanshao85/tideterm/issues). These docs are also open-source and we do accept PRs for docs [here](https://github.com/sanshao85/tideterm/blob/main/docs). You can click the "Edit this page" link at the bottom of the page to get taken directly to the editor page for that document in GitHub.
